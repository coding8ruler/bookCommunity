...
public class JoinRequest {
	...
	public void validate(Map<String, Boolean> errors) {
		...
		checkEmpty(errors, this.postcode, "postcode"); //우편번호 필수 입력
		checkEmpty(errors, this.jibunAddress, "jibunAddress"); //지번 필수 입력
	...
	public String toString() {
		return "JoinRequest [m_no=" + m_no + ", mId=" + mId + ", mPwd=" + mPwd + ", re_mPwd=" + re_mPwd + ", mName="
				+ mName + ", email=" + email + ", gender=" + gender + ", postcode=" + postcode + ", jibunAddress="
				+ jibunAddress + "]";
	}
