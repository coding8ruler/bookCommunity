...
<br/><br/><br/><br/>
	...
	<form name="writeFrm" id="writeFrm" method="post" action="<%=request.getContextPath()%>/eWrite.do">
			...
			<tr>
		 	...
		 	<tr>
		 		...
		 		<td>
		 			...
		 			<span class="error"><c:if test="${errors.E_TITLE}">제목을 입력하세요</c:if></span>
		 		</td>
		 	</tr>
		 	<tr>
		 		<th>내용</th>
		 		<td>
		 			<textarea name="E_CONTENT" id="E_CONTENT" rows="5" cols="30"></textarea>
		 			<span class="error"><c:if test="${errors.E_CONTENT}">내용을 입력하세요</c:if></span>
		 		</td>
		 	</tr>
		 	<tr>          
		 		...
		 		<center><a href="<%=request.getContextPath()%>/event.do">목록보기</a></center>
	</form>
</body>
</html>
