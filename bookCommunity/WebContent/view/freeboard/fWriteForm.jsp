...
<div class="container">
	<h2>글쓰기</h2>
	<hr/>
	<form name="writeFrm" id="writeFrm" method="post"  action="<%=request.getContextPath()%>/fWrite.do">
		<input type="hidden" name="rowSize" id="rowSize" value="${rowSize}"/>
			<div class="form-group">
			<label for="writer">작성자</label>
			<input type="text" name="writername" class="form-control" value="${authUser.mName}">
		 </div>
		  <div class="form-group">
			<label for="title">제목</label>
			<input type="text" name="fTitle" id="fTitle" class="form-control" placeholder="제목을 입력하세요">
			<span class="error"><c:if test="${errors.fTitle}">제목을 입력하세요</c:if></span>
		 </div>
		  <div class="form-group">
		 	<textarea name="fContent" id="fContent" rows="20" cols="100" placeholder="내용을 입력하세요"></textarea>
		 	<span class="error"><c:if test="${errors.fContent}">내용을입력하세요</c:if></span>
		 </div>
    ...
    <div class="find-btn">
		<button onClick="submit" class="write_btn">등록</button>
	</div>
	</form>
	</div>
