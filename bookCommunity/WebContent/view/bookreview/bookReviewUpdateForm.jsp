...
<br/><br/><br/><br/><br/>
 <div class="container">
<h3>독후감 수정</h3>
 <form name="updateFrm" id="updateFrm" method="post" action="<%=request.getContextPath()%>/bupdate.do">
  <input type="hidden" name="no" id="no" value="${bupReq.no}"/>
  <input type="hidden" name="rowSize" id="rowSize" value="${rowSize}"/>
  <input type="hidden" name="writer_name" id="writer_name" value="${bupReq.bWriterName}"/>
 <div class="form-group">
 <label for="writer_name">작성자</label>
		<input type="text" name="writer_name" class="form-control" value="${bupReq.bWriterName}">
 </div>
 <div class="form-group">
		<label for="title">책 제목</label>
		<input type="text" name="booktitle" id="booktitle" class="form-control" value="${bupReq.bookTitle}">
</div>
 <div class="form-group">
		<label for="title">저자</label>
		<input type="text" name="author" id="author" class="form-control" value="${bupReq.author}">
</div>
 <div class="form-group">
		<label for="title">출판사</label>
		<input type="text" name="publisher" id="publisher" class="form-control" value="${bupReq.publisher}">
</div>
 <div class="form-group">
		<label for="title">제목</label>
		<input type="text" name="title" id="title" class="form-control" value="${bupReq.bTitle}">
</div>
<div class="form-group">
		 	<textarea name="content" id="content" rows="20" cols="100">${bupReq.bContent}</textarea>
		 </div>
	...
	<script>
      ...
      language: "ko"
		...
		<a href="<%=request.getContextPath()%>/blist.do?rowSize=${rowSize}">취소</a> 
</form>
