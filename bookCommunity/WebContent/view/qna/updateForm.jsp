...
<br/><br/><br/>
  ...
  <form name="updateFrm" id="updateFrm" 
       method="post" action="<%=request.getContextPath()%>/qUpdate.do">
 <table border="1"  style="width: 600px; margin-left: auto; margin-right: auto;">
 	...
 	<tr>
 	 <th>작성자명</th>
 	 <td>${upReq.q_writername}</td>
 	</tr>
 	<tr>
 	 <th>제목</th>
 	 <td>
 	  <input type="text" name="title" id="title" value="${upReq.q_title}"/>
 	 </td>
 	</tr>
 	<tr>
 	 <th>내용</th>
 	 <td>
 	 	<textarea name="content" id="content" rows="5" cols="30">${upReq.q_content}</textarea>
 	 </td>
 	</tr>
 	<tr>          
 	...
 	<div id="list">
 	  ...
 	  <input type="hidden" name="writer_name" id="writer_name" value="${upReq.q_writername}"/>	  
 </form>
</body>
</html>
