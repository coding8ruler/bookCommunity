...
<br/><br/><br/>
	...
	<form name="writeFrm" id="writeFrm" method="post" action="<%=request.getContextPath()%>/qWrite.do">
			...
			<tr>
		 	...
		 	<tr>
		 		...
		 		<td>
		 			...
		 			<span class="error"><c:if test="${errors.Q_TITLE}">제목을 입력하세요</c:if></span>
		 		</td>
		 	</tr>
		 	<tr>
		 		<th>내용</th>
		 		<td>
		 			<textarea name="Q_CONTENT" id="Q_CONTENT" rows="5" cols="30"></textarea>
		 			<span class="error"><c:if test="${errors.Q_CONTENT}">내용을 입력하세요</c:if></span>
		 		</td>
		 	</tr>
		 	<tr>          
