...
$(window).scroll(function(){  //스크롤이 움직일때마다 이벤트 발생
	...
	$(function() {
		...
		$("#btnList").click(function() {
			...
			location.href="/recomboardListboard.do?pageNo="+${pageNo}+"&rowSize="+${rowSize};
		...
		$("#btnDelete").click(function(no) {
			...
			if(confirm("삭제하시겠습니까?")) {
				location.href = "/recomboardDelete.do?no="+no;
			}
		});
	});
	</script>
...
<br/><br/><br/>	
	<h2 align="center">추천 게시판 수정완료</h2>
    <br/><br/> 
    ...
    <table border="1" style="width: 900px; margin-left: auto; margin-right: auto;">
    	...
    	<tr>
    		...
    		<td align="left" valign="middle">
    			<img src="../uploadImage/${updateReq.recomFile.fileRealName}" style="height:300px; width:600px;">
    		</td>
    	</tr>
    	<tr>
    		<th>게시판 내용</th>
    		<td>
    			<textarea style="width: 600px; height: 200px" readonly="readonly">${updateReq.rContent}</textarea>
    		</td>
    	</tr>
    	<tr>
    		<th>좋아요</th>
