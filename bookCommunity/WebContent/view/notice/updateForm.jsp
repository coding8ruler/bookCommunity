...
<div id="Quick" class="" style="position: absolute; right: 10px; top: 400px;">
 ...
 <h2>공지사항 수정</h2>
 <hr/>
 <form name="updateFrm" id="updateFrm" method="post" action="<%=request.getContextPath()%>/nUpdate.do">
 	  <input type="hidden" name="no" id="no" value="${upReq.no}"/>
 	  <input type="hidden" name="writer_name" id="writer_name" value="${upReq.n_writername}"/>	  
 <div class="form-group">
 <label for="writer_name">작성자</label>
		<input type="text" name="writername" class="form-control" value="${upReq.n_writername}">
 </div>
 <div class="form-group">
		<label for="title">제목</label>
		<input type="text" name="title" id="title" class="form-control" value="${upReq.n_title}">
</div>
<div class="form-group">
		 	<textarea name="content" id="content" rows="20" cols="100">${upReq.n_content}</textarea>
		 </div>
	...
	<div class="find-btn">
		<button onClick="submit" class="write_btn">수정</button>
	</div>
</form>
</div>		
</body>
